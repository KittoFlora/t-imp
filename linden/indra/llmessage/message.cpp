...
{
//	if (true)		// ##kf set to true for tritium develop ####
	if (false)		// ##kf set to true for tritium develop ####
	{
		// ##kf Trap old message for convertion to SCP
		LL_WARNS("Messaging") << "++++ OLDMSG:" << mMessageBuilder->getMessageName() << " to " << host << llendl;
		return 1;	
	}
...
LL_WARNS("Messaging")	<< "StartPingCheck from message/message.cpp!" <<LL_ENDL;  //##kf tracking source	
