...
{
llinfos << "LLAssetStorage::getAssetData 407" << uuid << "  type " << type << llendl; //##kf
...
{
llinfos << "LLAssetStorage::getAssetData 1226" << uuid << "  type " << type << llendl; //##kf
...
llwarns << "/\\/\\/\\/\\/ legacyGetDataCallback writing " << filename << llendl;	// ##kf
