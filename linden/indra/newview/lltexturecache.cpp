...
llwarns << "++++++++ TxtCache  doRead " << local_filename << "  mState=" << mState << llendl; //##kf
...
llwarns << "++++++++ TxtCache  read local." << llendl; //##kf
	}
...
llwarns << "++++++++ TxtCache  read cache size = " << mDataSize << llendl; //##kf
	}
...
llwarns << "++++++++ TxtCache  read, filename " << filename << llendl; //##kf
