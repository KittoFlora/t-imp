	...
	const std::string& hashed_volume_serial)
{
	...
	LL_INFOS2("AppInit", "Authentication") << "LLUserAuth::authenticate: uri1=" << auth_uri << LL_ENDL;
}
	...
	const std::string& hashed_volume_serial)
{
	...
	LL_INFOS2("AppInit", "Authentication") << "LLUserAuth::authenticate: uri2=" << auth_uri << LL_ENDL;
}
