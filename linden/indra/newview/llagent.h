...
//	BOOL				getLookingAtAvatar() const;
	...
	static void 	t_AgentInitialWearablesUpdate(unsigned char *buffp);
	static void		t_ProcessAgentDataUpdate(unsigned char *buffp);	
...
public:
	...
	static void	t_InitialWearableAssetArrived(LLUUID asset_id, U32 asset_type, unsigned char* dptr, S32 length); //##kf
