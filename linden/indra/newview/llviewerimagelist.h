...
public:
	...
	static void SCTPreceiveImageHeader(LLUUID id, U8 codec, U16 packets, U32 totalbytes, S32 data_size, U8 *data);
	static void receiveImagePacket(LLMessageSystem *msg, void **user_data);
	static void SCTPreceiveImagePacket(LLUUID id, U16 packet_num, S32 data_size, U8 *data);
	static void SCTPImageNotInDatabase(LLUUID image_id);
public:
	LLViewerImageList();
	~LLViewerImageList();
