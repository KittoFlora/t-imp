...
public:
	...
	LLViewerObject *processCreateAvatar(LLUUID fullid, U32 local_id, U64 region_handle, U32 flags, LLHost sim); // ##kf  
	...
	void t_ProcessUpdateCore(LLViewerObject* objectp, U64 region_handle, U16 time_dilation, unsigned char *packet_bufferp, U32 obj_num);	//##kf
	void t_processAvatarCreate(LLUUID fullid, U32 local_id, U64 region_handle, U32 flags);   //##kf
	void t_ProcessObjectUpdate(unsigned char *packet_bufferp);	 	//##kf
