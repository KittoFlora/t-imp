...
llwarns << "+++++++++++++ In pipeline.cpp/LLPipeline::init()" << llendl;
llwarns << "+++++++++++++ In pipeline.cpp/LLPipeline::init()" << llendl;
...
{
//llwarns << "LLPipeline::addObject   " << vobj << llendl;

	if (gNoRender)
	{
//llwarns << "LLPipeline::addObject   gNoRender" << llendl;
		return 0;
	}
	static BOOL sRenderDelayCreation = gSavedSettings.getBOOL("RenderDelayCreation");
	if (sRenderDelayCreation)
	{
//llwarns << "LLPipeline::addObject   push_back" << llendl;
		mCreateQ.push_back(vobj);
	}
	else
	{
//llwarns << "LLPipeline::addObject   createObject" << llendl;
		createObject(vobj);
	}
...
//llwarns << "LLPipeline::createObject   drawablep = " << drawablep << llendl;
	if (!drawablep)
	{
//llwarns << "LLPipeline::createObject   !drawablep" << llendl;
		drawablep = vobj->createDrawable(this);
	}
	else
	{
//llwarns << "LLPipeline::createObject   Redundant" << llendl;
		llerrs << "Redundant drawable creation!" << llendl;
	}
//llwarns << "LLPipeline::createObject   made drawablep = " << drawablep << llendl;
	llassert(drawablep);

	if (vobj->getParent())
	{
//llwarns << "LLPipeline::createObject   setDrawableParent vobj" << llendl;
		vobj->setDrawableParent(((LLViewerObject*)vobj->getParent())->mDrawable); // LLPipeline::addObject 1
	}
	else
	{
//llwarns << "LLPipeline::createObject   setDrawableParent NULL" << llendl;
	...
	{
//llwarns << "LLPipeline::createObject   animated" << llendl;
		// fun animated res
