...
public:
	...
	enum { MEDIA_URL_REMOVED = 0x1, MEDIA_URL_ADDED = 0x2, MEDIA_URL_UPDATED = 0x4, INVALID_UPDATE = 0x80000000 };
 	...
 	virtual U32 t_ProcessUpdateMessage(U64 region_handle,			//##kf
									   	   U16 time_dilation16,
...
protected:
	...
	static LLViewerObject *processCreateAvatar(LLUUID fullid, U32 local_id, U64 region_handle, 
												U32 flags, U8 state, LLHost sim); //##kf 
